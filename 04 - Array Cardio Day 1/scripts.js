(function () {
    ...
    const fladn = inventors.map(({first, last}) => { return {first, last} });
    console.table(fladn);
    ...
    console.log(sortedByYearsLived.map(inventor => `${inventor.first}, ${inventor.last}, ${inventor.passed - inventor.year}`))
